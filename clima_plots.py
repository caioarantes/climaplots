...
from .clima_plots_dialog import climaplotsDialog
import os.path
...
class climaplots:
    ...
    def handleMouseDown(self, point, button):
        ...
        self.dlg.LongEdit.setText(str(round(newPoint.x(),4)))
        self.dlg.LatEdit.setText(str(round(newPoint.y(),4)))
    ...
    def run(self):
        ...
        self.dlg.rejected.connect(self.fun_fechou)

        if self.dlg.tabWidget.currentIndex() == 0:
            self.dlg.tamanho_inicial()           
